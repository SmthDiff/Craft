<template>
  <div class="relative bg-white shadow">
        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            ...
            <button @click="isOn = !isOn" type="button"
              ...
              -->
              <svg class="ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              :aria-checked="isOn"
              :class="isOn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-1'"
              class="absolute -ml-4 mt-3 transform z-10 px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2 transition ease-out duration-200">
          ...
          <div class="relative">
            ...
            <div
              :aria-checked="isOn"
              :class="isOn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-1'"
              class="absolute left-1/2 z-10 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0 transition ease-out duration-200">
              <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                  <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
    ...
    <div
      :aria-checked="openMobile"
      :class="openMobile ? 'opacity-100 scale-100' : 'opacity-0 scale-95'"
      class="absolute top-0 inset-x-0 z-10 p-2 transition transform origin-top-right md:hidden duration-200 ease-out">
...
export default Vue.extend({
  name: 'MainMenu' as string,
  data() {
    return {
      isOn: false as boolean,
      openMobile: false as boolean,
    }
  },
});
</script>
